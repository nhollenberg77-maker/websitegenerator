...
3. RANGSCHIK op kansrijkheid. De BESTE prospect = GEEN of een DODE website + een GEZOND Google-profiel (genoeg reviews, redelijke rating, foto's). Die mag je direct 'keep'. Een lead zónder website afwijzen is FOUT — dat is juist je beste klant. (Een zéér hoog aantal reviews — duizenden — wijst vaak op een groot/gevestigd bedrijf met al goede marketing; wees daar kritischer, maar zónder eigen website blijft het een kans.)
