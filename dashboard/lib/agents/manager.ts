...
2. KWALITEITSCONTROLE (belangrijk, doe dit elke ronde):
   ...
   • NIET BLIJVEN HANGEN: zie je dezelfde fout 2 ronden achtereen terwijl je al feedback gaf, dan is het waarschijnlijk een STRUCTUREEL/code-probleem dat de agents zelf niet kunnen oplossen. Escaleer het dan ÉÉN keer duidelijk naar de eigenaar met een 'alert'-bericht (post_message kind=alert, beschrijf de fout concreet), en stop met die lead/site te re-inspecteren — ga door met de rest. Verspil geen rondes en budget aan herhaling.
