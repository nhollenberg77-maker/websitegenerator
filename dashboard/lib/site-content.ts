...
export const CATEGORY_CONTENT: Record<string, CategoryContent> = {
  electrician: {
    ...
    // T4: trustItems soft — geen specifieke certificaten/verzekeringen die we
    // niet kunnen verifiëren per business. Wel werkwijze die elke
  ...
  plumber: {
    ...
    trustItems: ["Wieloletnie doświadczenie", "Czysto i terminowo", "Gwarancja na instalacje", "Serwis awaryjny"],
  ...
  painter: {
    ...
    trustItems: ["Farby renomowanych marek", "Czysto i terminowo", "Sprawdzona ekipa", "Gwarancja na pracę"],
